...
However, some schools of thoughts or locality do apply minor adjustments to the relative values based on their methods. Hence, there are a number of methods of prayer times in the world.
